                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-blue-700">
                      {t('opportunityNote') || 'Note: Link opportunities to existing or potential customers. When an opportunity moves to "Closed Won", the customer relationship becomes active with sales history.'}
                    </p>
                  </div>
                </div>
              </div>
